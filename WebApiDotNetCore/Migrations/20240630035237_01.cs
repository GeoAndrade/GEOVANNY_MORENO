    ...
    public partial class _01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdUserTask = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTasks", x => x.IdUserTask);
                    table.ForeignKey(
                        name: "FK_UserTasks_Users_IdUser",
                        column: x => x.IdUser,
                        principalSchema: "SEG",
                        principalTable: "Users",
                        principalColumn: "Id");
